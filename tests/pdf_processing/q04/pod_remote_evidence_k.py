...
STREAM_FILES = {
    "state/yolo-pod-cgroup-k-measurement/resource-attribution.jsonl",
    "vm-controller.jsonl",
    "workload.log",
}
FINAL_REQUIRED = {
    "state/yolo-pod-cgroup-k/phase-complete.json",
    "state/yolo-pod-cgroup-k/reviewed-window-contract.json",
    "state/yolo-pod-cgroup-k/fresh-index.json",
    "state/yolo-pod-cgroup-k/fresh-07/accepted.json",
    "state/yolo-pod-cgroup-k/fresh-07/document.json",
    "state/yolo-pod-cgroup-k/fresh-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-k/restored-07/accepted.json",
    "state/yolo-pod-cgroup-k/restored-07/document.json",
    "state/yolo-pod-cgroup-k/restored-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-k/replay-07/accepted.json",
    "state/yolo-pod-cgroup-k/replay-07/document.json",
    "state/yolo-pod-cgroup-k/replay-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-k-measurement/resource-attribution.jsonl",
    "state/yolo-pod-cgroup-k-measurement/resource-attribution-summary.json",
    "state/yolo-pod-cgroup-k-measurement/measurement-contract.json",
    "workload-exit.json",
...
ALLOWED_PREFIXES = (
    "state/yolo-pod-cgroup-k/",
    "state/yolo-pod-cgroup-k-measurement/",
)
