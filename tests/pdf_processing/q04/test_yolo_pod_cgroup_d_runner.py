...
class YoloPodCgroupDRunnerTests(unittest.TestCase):
    ...
    def test_new_identity_and_paths_do_not_reuse_c(self):
        ...
        self.assertEqual(scope["run_identity"], "q04-yolo-pod-cgroup-20260919-d")
        self.assertEqual(scope["evidence_pvc"], "q04-pod-cgroup-d-evidence-20260919-d")
        self.assertEqual(
            scope["evidence_directory_name"], "q04-yolo-pod-cgroup-20260919-d"
        )
    ...
    def test_topology_is_inactive_and_contains_only_d_identity(self):
    ...
    def test_generated_manifests_and_offline_check_are_exact(self):
        ...
        self.assertEqual(
            json.loads((runner.Q04 / "pod-topology-v3/SOURCE-MANIFEST.json").read_text()),
