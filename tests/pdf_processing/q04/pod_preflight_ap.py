...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_preflight_ap_engine", Path(__file__).with_name("pod_preflight_q.py")
)
...
def verify_workload_imports_ap(*, workspace, bundle, prefix):
    modules = (
        "candidate.relationship_interruption_window_ao",
        "pod_init_p",
        "pod_workload_ap",
        "pod_remote_evidence_ap",
        "host_ao",
        "worker_ao",
    )
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v41/RUNTIME-INTEGRATION-MANIFEST.json"
...
base.RUN_ID = RUN_ID
base.verify_configuration_q = verify_configuration_ap
base.verify_workload_imports_q = verify_workload_imports_ap
main = base.main
