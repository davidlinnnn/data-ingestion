...
RUN_ID = "q04-yolo-pod-cgroup-20260920-e"
WORKFLOW_QUEUE = "q04-pod-cgroup-e-workflows"
ACTIVITY_QUEUE = "q04-pod-cgroup-e-07"
EVIDENCE_ROOT = Path("/q04-evidence/q04-yolo-pod-cgroup-20260920-e")
PARSER_BUDGETS = {
    "startup_seconds": 120,
...
def build_init_argv(args) -> list[str]:
    return [
        args.python,
        str(args.workspace / "tests/pdf_processing/q04/pod_init_e.py"),
...
def cleanup_markers(state: Path) -> dict:
    roots = sorted(state.glob("yolo-pod-cgroup-e/worker-*"))
