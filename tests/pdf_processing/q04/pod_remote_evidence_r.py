"""Evidence paths for the original Q04 warm sequence."""
...
_spec = importlib.util.spec_from_file_location("q04_pod_remote_evidence_r_engine", Path(__file__).with_name("pod_remote_evidence_p.py"))
