...
import pod_preflight_p as preflight
    ...
    def test_single_preflight_returns_all_gates_without_starting_work(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            source_manifest.write_text(json.dumps({
                "phase": "q04-pod-cgroup-p", "producer": {}, "harness": {},
            ...
            evidence_directory.prepare_run_directory(
                mount,
                "q04-yolo-pod-cgroup-20260920-p",
            ...
            with mock.patch.object(
                ...
                result = preflight.run_preflight(
                    workspace=root,
                    mount_root=mount,
                    evidence_directory_name="q04-yolo-pod-cgroup-20260920-p",
                    model_cache=root,
                    provenance=root,
                    python=Path(sys.executable),
                    cgroup_root=root,
