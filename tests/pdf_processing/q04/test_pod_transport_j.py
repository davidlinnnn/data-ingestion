...
class TransportTests(unittest.TestCase):
    def setUp(self):
        ...
        self.volume = {'pvc_uid':'claim-j', 'pv_uid':'pv-j'}
    ...
    def failure_export(self, full_cleanup=False):
        ...
        if full_cleanup:
            ...
            owned = [{"kind":"PersistentVolumeClaim", "name":"evidence", "uid":"claim-j"},
                     {"kind":"ConfigMap", "name":"harness", "uid":"cm-j"},
                     {"kind":"Deployment", "name":"worker", "uid":"dep-j"}]
            ...
            namespace.update(
                ...
                deployment={"metadata":{"uid":"dep-j"}}, cleanup_identity=None,
                ...
                verify_retained_evidence_claim=lambda *a,**k:{"pvc_uid":"claim-j","retained":True},
