"""Offline contracts for the follow-up Q04 Pod cgroup G runner."""
...
import pod_topology_g as topology
import pod_remote_evidence_g as remote_evidence
import pod_workload_g as workload
from sentinel import run_yolo_pod_cgroup_g as runner


class YoloPodCgroupGRunnerTests(unittest.TestCase):
    ...
    def test_new_identity_and_paths_do_not_reuse_c(self):
        ...
        self.assertEqual(scope["run_identity"], "q04-yolo-pod-cgroup-20260920-g")
        self.assertEqual(scope["evidence_pvc"], "q04-pod-cgroup-g-evidence-20260920-g")
        self.assertEqual(
            scope["evidence_directory_name"], "q04-yolo-pod-cgroup-20260920-g"
        )
    ...
    def test_single_gate_set_precedes_workload_and_uses_staged_inputs(self):
        ...
        self.assertIn("pod_preflight_g.py", argv[1])
        self.assertEqual(
    ...
    def test_topology_is_inactive_and_contains_only_g_identity(self):
    ...
    def test_generated_manifests_and_offline_check_are_exact(self):
        ...
        self.assertEqual(
            json.loads((runner.Q04 / "pod-topology-v6/SOURCE-MANIFEST.json").read_text()),
