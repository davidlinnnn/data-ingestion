...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_preflight_aw_engine", Path(__file__).with_name("pod_preflight_q.py")
)
...
TOPOLOGY_PHASE = "q04-pod-cgroup-aw"
RUN_ID = "q04-process-drain-pod-cgroup-20260925-aw"
...
def verify_workload_imports_at(*, workspace, bundle, prefix):
    modules = (
        "candidate.process_drain_window_aw",
        "pod_init_p",
        "pod_workload_aw",
        "pod_remote_evidence_aw",
        "host_an",
        "worker",
    )
    ...
    from candidate.process_drain_window_aw import validate_scope
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v48/RUNTIME-INTEGRATION-MANIFEST.json"
