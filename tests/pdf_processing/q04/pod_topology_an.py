...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_an_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/method-pod-cgroup-20260924-an/"
base.EVIDENCE_PVC = "q04-pod-cgroup-an-evidence-20260924-an"
base.EVIDENCE_DIRECTORY_NAME = "q04-method-pod-cgroup-20260924-an"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    "tests/pdf_processing/q04/candidate/method_invalidation_window_an.py",
    ...
    "tests/pdf_processing/q04/pod_workload_an.py",
    "tests/pdf_processing/q04/pod_preflight_an.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_an.py",
    "tests/pdf_processing/q04/pod_topology_an.py",
    "tests/pdf_processing/q04/host_an.py",
    "tests/pdf_processing/q04/pod-topology-v39/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
