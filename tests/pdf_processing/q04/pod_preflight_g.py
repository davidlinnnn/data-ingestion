"""One-shot pre-inference gate set for the Q04 fixture-07 Pod window G."""
...
def verify_workload_imports() -> dict:
    imported = []
...
def verify_configuration(
    *,
    ...
    if source_manifest.get("phase") != "q04-pod-cgroup-g":
    ...
    *,
    ...
    capture(
        ...
        lambda: verify_configuration(
            ...
            expected_phase="yolo-pod-cgroup-g",
        )[1],
    )
    capture(
        "source_hashes",
    ...
    capture("workload_imports", workload_import_probe)
    capture(
        "temporal",
