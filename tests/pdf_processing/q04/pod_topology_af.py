...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_af_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/warm-pod-cgroup-20260922-af/"
base.EVIDENCE_PVC = "q04-pod-cgroup-af-evidence-20260922-af"
base.EVIDENCE_DIRECTORY_NAME = "q04-warm-pod-cgroup-20260922-af"
base.PRODUCER_MANIFEST = base.Q04 / "candidate/warm-lifecycle-af/MANIFEST.json"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    ...
    "tests/pdf_processing/q04/candidate/warm-lifecycle-af/MANIFEST.json",
    "tests/pdf_processing/q04/candidate/yolo-equivalence-v2/ADOPTION.json",
    "tests/pdf_processing/q04/pod_workload_af.py",
    "tests/pdf_processing/q04/pod_preflight_af.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_af.py",
    "tests/pdf_processing/q04/pod_topology_af.py",
    "tests/pdf_processing/q04/pod-topology-v31/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
