...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_ah_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/warm-pod-cgroup-20260924-ah/"
base.EVIDENCE_PVC = "q04-pod-cgroup-ah-evidence-20260924-ah"
base.EVIDENCE_DIRECTORY_NAME = "q04-warm-pod-cgroup-20260924-ah"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    "tests/pdf_processing/q04/candidate/warm_pod_window_v3.py",
    ...
    "tests/pdf_processing/q04/pod_workload_ah.py",
    "tests/pdf_processing/q04/pod_preflight_ah.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_ah.py",
    "tests/pdf_processing/q04/pod_topology_ah.py",
    "tests/pdf_processing/q04/pod-topology-v33/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
