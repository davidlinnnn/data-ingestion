...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_preflight_ba_engine", Path(__file__).with_name("pod_preflight_q.py")
)
...
TOPOLOGY_PHASE = "q04-pod-cgroup-ba"
RUN_ID = "q04-process-drain-pod-cgroup-20260925-ba"
...
def verify_workload_imports_at(*, workspace, bundle, prefix):
    modules = (
        "candidate.process_drain_window_ba",
        "pod_init_p",
        "pod_workload_ba",
        "pod_remote_evidence_ba",
        "host_an",
        "worker",
    )
    ...
    from candidate.process_drain_window_ba import validate_scope
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v52/RUNTIME-INTEGRATION-MANIFEST.json"
