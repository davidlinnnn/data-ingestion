...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_remote_evidence_ak_engine",
...
FINAL_REQUIRED = {
    ...
    *{
        ...
        for label in ("fresh-native", "replay-native")
        for name in ("accepted.json", "document.json")
    },
    f"state/{PHASE}/old-request-native/accepted.json",
    f"state/{PHASE}/old-request-native/result.json",
    f"state/{PHASE}/old-request-native/history.json",
    f"state/{MEASUREMENT}/resource-attribution.jsonl",
