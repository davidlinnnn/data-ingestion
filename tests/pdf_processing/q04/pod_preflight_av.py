...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_preflight_av_engine", Path(__file__).with_name("pod_preflight_q.py")
)
...
TOPOLOGY_PHASE = "q04-pod-cgroup-av"
RUN_ID = "q04-process-drain-pod-cgroup-20260925-av"
...
def verify_workload_imports_at(*, workspace, bundle, prefix):
    modules = (
        "candidate.process_drain_window_av",
        "pod_init_p",
        "pod_workload_av",
        "pod_remote_evidence_av",
        "host_av",
        "worker",
    )
    ...
    from candidate.process_drain_window_av import validate_scope
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v47/RUNTIME-INTEGRATION-MANIFEST.json"
