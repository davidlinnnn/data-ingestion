"""Local contracts for the AT active telemetry-loss window."""
...
from candidate import telemetry_loss_window_at as matrix
from candidate.telemetry_loss_window_at import validate_scope
import pod_topology_at as topology
import pod_workload_at as workload
from sentinel import node_pressure_attribution as probe
from sentinel import run_telemetry_loss_pod_cgroup_at as runner
from sentinel import run_telemetry_loss_pod_cgroup_at_guarded as guarded
...
class ATTelemetryLossTest(unittest.TestCase):
    ...
    def test_identity_scope_and_owned_probe_command(self):
        ...
        path = topology.base.Q04 / "pod-topology-v45/RUNTIME-INTEGRATION-MANIFEST.json"
        ...
        self.assertIn("run_telemetry_loss_pod_cgroup_at_guarded.py", runner.exact_command())
        ...
        self.assertEqual(guarded.PROBE_NAME, "q04-host-pressure-at-20260925")
    ...
    def test_exact_projected_workspace_imports(self):
        ...
        with tempfile.TemporaryDirectory() as raw:
            ...
            result = subprocess.run([sys.executable, "-c",
                "import pod_preflight_at; from pathlib import Path; "
                "pod_preflight_at.verify_workload_imports_at("
