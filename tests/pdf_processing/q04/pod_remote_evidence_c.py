...
STREAM_FILES = {
    "state/yolo-pod-cgroup-c-measurement/resource-attribution.jsonl",
    "vm-controller.jsonl",
    "workload.log",
}
FINAL_REQUIRED = {
    "state/yolo-pod-cgroup-c/phase-complete.json",
    "state/yolo-pod-cgroup-c/reviewed-window-contract.json",
    "state/yolo-pod-cgroup-c/fresh-index.json",
    "state/yolo-pod-cgroup-c/fresh-07/accepted.json",
    "state/yolo-pod-cgroup-c/fresh-07/document.json",
    "state/yolo-pod-cgroup-c/fresh-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-c/restored-07/accepted.json",
    "state/yolo-pod-cgroup-c/restored-07/document.json",
    "state/yolo-pod-cgroup-c/restored-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-c/replay-07/accepted.json",
    "state/yolo-pod-cgroup-c/replay-07/document.json",
    "state/yolo-pod-cgroup-c/replay-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-c-measurement/resource-attribution.jsonl",
    "state/yolo-pod-cgroup-c-measurement/resource-attribution-summary.json",
    "state/yolo-pod-cgroup-c-measurement/measurement-contract.json",
    "workload-exit.json",
...
ALLOWED_PREFIXES = (
    "state/yolo-pod-cgroup-c/",
    "state/yolo-pod-cgroup-c-measurement/",
)
