...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_preflight_ax_engine", Path(__file__).with_name("pod_preflight_q.py")
)
...
TOPOLOGY_PHASE = "q04-pod-cgroup-ax"
RUN_ID = "q04-process-drain-pod-cgroup-20260925-ax"
...
def verify_workload_imports_at(*, workspace, bundle, prefix):
    modules = (
        "candidate.process_drain_window_ax",
        "pod_init_p",
        "pod_workload_ax",
        "pod_remote_evidence_ax",
        "host_an",
        "worker",
    )
    ...
    from candidate.process_drain_window_ax import validate_scope
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v49/RUNTIME-INTEGRATION-MANIFEST.json"
