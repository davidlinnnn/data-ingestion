...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_ao_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/relationship-pod-cgroup-20260924-ao/"
base.EVIDENCE_PVC = "q04-pod-cgroup-ao-evidence-20260924-ao"
base.EVIDENCE_DIRECTORY_NAME = "q04-relationship-pod-cgroup-20260924-ao"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    ...
    "tests/pdf_processing/q04/pod_workload_ao.py",
    "tests/pdf_processing/q04/pod_preflight_ao.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_ao.py",
    "tests/pdf_processing/q04/pod_topology_ao.py",
    ...
    "tests/pdf_processing/q04/pod-topology-v40/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
