...
STREAM_FILES = {
    "state/yolo-pod-cgroup-f-measurement/resource-attribution.jsonl",
    "vm-controller.jsonl",
    "workload.log",
}
FINAL_REQUIRED = {
    "state/yolo-pod-cgroup-f/phase-complete.json",
    "state/yolo-pod-cgroup-f/reviewed-window-contract.json",
    "state/yolo-pod-cgroup-f/fresh-index.json",
    "state/yolo-pod-cgroup-f/fresh-07/accepted.json",
    "state/yolo-pod-cgroup-f/fresh-07/document.json",
    "state/yolo-pod-cgroup-f/fresh-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-f/restored-07/accepted.json",
    "state/yolo-pod-cgroup-f/restored-07/document.json",
    "state/yolo-pod-cgroup-f/restored-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-f/replay-07/accepted.json",
    "state/yolo-pod-cgroup-f/replay-07/document.json",
    "state/yolo-pod-cgroup-f/replay-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-f-measurement/resource-attribution.jsonl",
    "state/yolo-pod-cgroup-f-measurement/resource-attribution-summary.json",
    "state/yolo-pod-cgroup-f-measurement/measurement-contract.json",
    "workload-exit.json",
...
ALLOWED_PREFIXES = (
    "state/yolo-pod-cgroup-f/",
    "state/yolo-pod-cgroup-f-measurement/",
)
