...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_y_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/warm-pod-cgroup-20260921-y/"
base.EVIDENCE_PVC = "q04-pod-cgroup-y-evidence-20260921-y"
base.EVIDENCE_DIRECTORY_NAME = "q04-warm-pod-cgroup-20260921-y"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    ...
    "tests/pdf_processing/q04/candidate/warm-lifecycle-y/MANIFEST.json",
    "tests/pdf_processing/q04/candidate/yolo-equivalence-v2/ADOPTION.json",
    "tests/pdf_processing/q04/pod_workload_y.py",
    "tests/pdf_processing/q04/pod_preflight_y.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_y.py",
    "tests/pdf_processing/q04/pod_topology_y.py",
    "tests/pdf_processing/q04/pod-topology-v24/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
