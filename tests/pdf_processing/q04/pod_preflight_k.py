...
def verify_reviewed_contract(*, workspace: Path, bundle: Path, prefix: str) -> dict:
    ...
    integration_manifest = (
        q04 / "pod-topology-v10/RUNTIME-INTEGRATION-MANIFEST.json"
    )
    ...
    args = argparse.Namespace(
        bundle=bundle,
        name="yolo-pod-cgroup-k",
        fixture="07",
        modes=["fresh", "restored", "replay"],
        expected_run_id="q04-yolo-pod-cgroup-20260920-k",
...
def verify_configuration(
    *,
    ...
    if source_manifest.get("phase") != "q04-pod-cgroup-k":
    ...
    *,
    ...
    capture(
        ...
        lambda: verify_configuration(
            ...
            expected_phase="yolo-pod-cgroup-k",
        )[1],
    )
    capture(
        "source_hashes",
