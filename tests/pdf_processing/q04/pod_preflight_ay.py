...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_preflight_ay_engine", Path(__file__).with_name("pod_preflight_q.py")
)
...
TOPOLOGY_PHASE = "q04-pod-cgroup-ay"
RUN_ID = "q04-process-drain-pod-cgroup-20260925-ay"
...
def verify_workload_imports_at(*, workspace, bundle, prefix):
    modules = (
        "candidate.process_drain_window_ay",
        "pod_init_p",
        "pod_workload_ay",
        "pod_remote_evidence_ay",
        "host_an",
        "worker",
    )
    ...
    from candidate.process_drain_window_ay import validate_scope
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v50/RUNTIME-INTEGRATION-MANIFEST.json"
