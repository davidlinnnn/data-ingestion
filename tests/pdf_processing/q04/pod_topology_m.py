...
PHASE = "q04-pod-cgroup-m"
DEPLOYMENT = PHASE + "-activities"
RUN_LABEL = PHASE
WORKFLOW_QUEUE = PHASE + "-workflows"
ACTIVITY_QUEUE = PHASE + "-07"
OBJECT_PREFIX = "q04/yolo-pod-cgroup-20260920-m/"
MEMORY_REQUEST = "4Gi"
MEMORY_LIMIT = "5Gi"
EPHEMERAL_REQUEST = "3Gi"
EPHEMERAL_LIMIT = "4Gi"
EVIDENCE_PVC = "q04-pod-cgroup-m-evidence-20260920-m"
EVIDENCE_DIRECTORY_NAME = "q04-yolo-pod-cgroup-20260920-m"
...
POD_ONLY_FILES = (
    ...
    "tests/pdf_processing/q04/pod_workload_m.py",
    "tests/pdf_processing/q04/pod_init_m.py",
    "tests/pdf_processing/q04/pod_remote_evidence_m.py",
    "tests/pdf_processing/q04/pod_durable_evidence.py",
    "tests/pdf_processing/q04/pod_evidence_directory_d.py",
    "tests/pdf_processing/q04/pod_preflight_m.py",
