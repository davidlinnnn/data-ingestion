...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_au_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/telemetry-loss-pod-cgroup-20260925-au/"
base.EVIDENCE_PVC = "q04-pod-cgroup-au-evidence-20260925-au"
base.EVIDENCE_DIRECTORY_NAME = "q04-telemetry-loss-pod-cgroup-20260925-au"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    "tests/pdf_processing/q04/candidate/telemetry_loss_window_au.py",
    ...
    "tests/pdf_processing/q04/pod_workload_au.py",
    "tests/pdf_processing/q04/pod_preflight_au.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_au.py",
    "tests/pdf_processing/q04/pod_topology_au.py",
    "tests/pdf_processing/q04/host_an.py",
    "tests/pdf_processing/q04/pod-topology-v46/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
