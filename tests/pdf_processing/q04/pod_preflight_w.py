...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_preflight_w_engine", Path(__file__).with_name("pod_preflight_q.py")
)
...
TOPOLOGY_PHASE = "q04-pod-cgroup-w"
RUN_ID = "q04-warm-pod-cgroup-20260921-w"
sha256 = base.base.sha256


def verify_configuration_w(**kwargs):
...
def verify_workload_imports_w(*, workspace, bundle, prefix):
    modules = (
        "candidate.warm_pod_window_r",
        "pod_init_p",
        "pod_workload_w",
        "pod_remote_evidence_w",
    )
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v22/RUNTIME-INTEGRATION-MANIFEST.json"
...
base.RUN_ID = RUN_ID
base.verify_configuration_q = verify_configuration_w
base.verify_workload_imports_q = verify_workload_imports_w
main = base.main
