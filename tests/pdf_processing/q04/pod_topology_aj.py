...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_aj_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/matrix-pod-cgroup-20260924-aj/"
base.EVIDENCE_PVC = "q04-pod-cgroup-aj-evidence-20260924-aj"
base.EVIDENCE_DIRECTORY_NAME = "q04-matrix-pod-cgroup-20260924-aj"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    "tests/pdf_processing/q04/candidate/matrix_v3_window_aj.py",
    ...
    "tests/pdf_processing/q04/pod_workload_aj.py",
    "tests/pdf_processing/q04/pod_preflight_aj.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_aj.py",
    "tests/pdf_processing/q04/pod_topology_aj.py",
    "tests/pdf_processing/q04/pod-topology-v35/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
