...
STREAM_FILES = {
    "state/yolo-pod-cgroup-j-measurement/resource-attribution.jsonl",
    "vm-controller.jsonl",
    "workload.log",
}
FINAL_REQUIRED = {
    "state/yolo-pod-cgroup-j/phase-complete.json",
    "state/yolo-pod-cgroup-j/reviewed-window-contract.json",
    "state/yolo-pod-cgroup-j/fresh-index.json",
    "state/yolo-pod-cgroup-j/fresh-07/accepted.json",
    "state/yolo-pod-cgroup-j/fresh-07/document.json",
    "state/yolo-pod-cgroup-j/fresh-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-j/restored-07/accepted.json",
    "state/yolo-pod-cgroup-j/restored-07/document.json",
    "state/yolo-pod-cgroup-j/restored-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-j/replay-07/accepted.json",
    "state/yolo-pod-cgroup-j/replay-07/document.json",
    "state/yolo-pod-cgroup-j/replay-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-j-measurement/resource-attribution.jsonl",
    "state/yolo-pod-cgroup-j-measurement/resource-attribution-summary.json",
    "state/yolo-pod-cgroup-j-measurement/measurement-contract.json",
    "workload-exit.json",
...
ALLOWED_PREFIXES = (
    "state/yolo-pod-cgroup-j/",
    "state/yolo-pod-cgroup-j-measurement/",
)
