...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_workload_aa_engine", Path(__file__).with_name("pod_workload_p.py")
)
...
RUN_ID = "q04-warm-pod-cgroup-20260921-aa"
WORKFLOW_QUEUE = "q04-pod-cgroup-aa-workflows"
ACTIVITY_QUEUE = "q04-pod-cgroup-aa-08"
EVIDENCE_ROOT = Path("/q04-evidence/q04-warm-pod-cgroup-20260921-aa")
...
def build_measurement_argv(args, run_id: str, authorization_sha256: str) -> list[str]:
    return [
        ...
        str(args.workspace / "tests/pdf_processing/q04/pod-topology-v26/RUNTIME-INTEGRATION-MANIFEST.json"),
...
def adapt_run():
    ...
    source = source.replace(
        old, "pod-topology-v26/RUNTIME-INTEGRATION-MANIFEST.json"
    )
