...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_preflight_az_engine", Path(__file__).with_name("pod_preflight_q.py")
)
...
TOPOLOGY_PHASE = "q04-pod-cgroup-az"
RUN_ID = "q04-process-drain-pod-cgroup-20260925-az"
...
def verify_workload_imports_at(*, workspace, bundle, prefix):
    modules = (
        "candidate.process_drain_window_az",
        "pod_init_p",
        "pod_workload_az",
        "pod_remote_evidence_az",
        "host_an",
        "worker",
    )
    ...
    from candidate.process_drain_window_az import validate_scope
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v51/RUNTIME-INTEGRATION-MANIFEST.json"
