...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_preflight_au_engine", Path(__file__).with_name("pod_preflight_q.py")
)
...
TOPOLOGY_PHASE = "q04-pod-cgroup-au"
RUN_ID = "q04-telemetry-loss-pod-cgroup-20260925-au"
...
def verify_workload_imports_at(*, workspace, bundle, prefix):
    modules = (
        "candidate.telemetry_loss_window_au",
        "pod_init_p",
        "pod_workload_au",
        "pod_remote_evidence_au",
        "host_an",
        "worker",
    )
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v46/RUNTIME-INTEGRATION-MANIFEST.json"
