...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_av_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/process-drain-pod-cgroup-20260925-av/"
base.EVIDENCE_PVC = "q04-pod-cgroup-av-evidence-20260925-av"
base.EVIDENCE_DIRECTORY_NAME = "q04-process-drain-pod-cgroup-20260925-av"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    "tests/pdf_processing/q04/candidate/process_drain_window_av.py",
    ...
    "tests/pdf_processing/q04/pod_workload_av.py",
    "tests/pdf_processing/q04/pod_preflight_av.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_av.py",
    "tests/pdf_processing/q04/pod_topology_av.py",
    "tests/pdf_processing/q04/host_an.py",
    "tests/pdf_processing/q04/host_av.py",
    "tests/pdf_processing/q04/pod-topology-v47/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
