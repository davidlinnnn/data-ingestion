"""Offline contracts for the follow-up Q04 Pod cgroup E runner."""
...
import pod_topology_e as topology
import pod_remote_evidence_e as remote_evidence
import pod_workload_e as workload
from sentinel import run_yolo_pod_cgroup_e as runner


class YoloPodCgroupERunnerTests(unittest.TestCase):
    ...
    def test_new_identity_and_paths_do_not_reuse_c(self):
        ...
        self.assertEqual(scope["run_identity"], "q04-yolo-pod-cgroup-20260920-e")
        self.assertEqual(scope["evidence_pvc"], "q04-pod-cgroup-e-evidence-20260920-e")
        self.assertEqual(
            scope["evidence_directory_name"], "q04-yolo-pod-cgroup-20260920-e"
        )
    ...
    def test_single_gate_set_precedes_workload_and_uses_staged_inputs(self):
        ...
        self.assertIn("pod_preflight_e.py", argv[1])
        self.assertEqual(
    ...
    def test_topology_is_inactive_and_contains_only_e_identity(self):
    ...
    def test_generated_manifests_and_offline_check_are_exact(self):
        ...
        self.assertEqual(
            json.loads((runner.Q04 / "pod-topology-v4/SOURCE-MANIFEST.json").read_text()),
