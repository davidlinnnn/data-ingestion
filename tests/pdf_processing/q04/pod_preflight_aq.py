...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_preflight_aq_engine", Path(__file__).with_name("pod_preflight_q.py")
)
...
def verify_workload_imports_aq(*, workspace, bundle, prefix):
    modules = (
        "candidate.relationship_interruption_window_ao",
        "pod_init_p",
        "pod_workload_aq",
        "pod_remote_evidence_aq",
        "host_ao",
        "worker_ao",
    )
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v42/RUNTIME-INTEGRATION-MANIFEST.json"
...
base.RUN_ID = RUN_ID
base.verify_configuration_q = verify_configuration_aq
base.verify_workload_imports_q = verify_workload_imports_aq
main = base.main
