...
WORKLOAD_IMPORTS = (
    "candidate.aima_pod_window_o",
    "pod_init_o",
    "pod_workload_o",
    "pod_remote_evidence_o",
)
...
def verify_reviewed_contract(*, workspace: Path, bundle: Path, prefix: str) -> dict:
    ...
    path = workspace / 'tests/pdf_processing/q04/pod-topology-v14/RUNTIME-INTEGRATION-MANIFEST.json'
    ...
    validate_scope(argparse.Namespace(integration_manifest=path,
        ...
        name='aima-pod-cgroup-o', expected_run_id='q04-aima-pod-cgroup-20260920-o',
        expected_prefix=prefix))
    return {'status':'PASS', 'fixture':'08', 'parser_max_requests':20,
            'oracle':'Q04 AIMA source oracle plus source-verified 21 image additions', 'production_default_changed':False}
...
def verify_configuration(
    *,
    ...
    if source_manifest.get("phase") != "q04-pod-cgroup-o":
    ...
    *,
    ...
    capture(
        ...
        lambda: verify_configuration(
            ...
            expected_phase="aima-pod-cgroup-o",
        )[1],
    )
    capture(
        "source_hashes",
