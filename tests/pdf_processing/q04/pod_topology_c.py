...
PHASE = "q04-pod-cgroup-c"
DEPLOYMENT = PHASE + "-activities"
RUN_LABEL = PHASE
WORKFLOW_QUEUE = PHASE + "-workflows"
ACTIVITY_QUEUE = PHASE + "-07"
OBJECT_PREFIX = "q04/yolo-pod-cgroup-20260919-c/"
MEMORY_REQUEST = "4Gi"
MEMORY_LIMIT = "5Gi"
EPHEMERAL_REQUEST = "3Gi"
EPHEMERAL_LIMIT = "4Gi"
EVIDENCE_PVC = "q04-pod-cgroup-c-evidence-20260919-c"
...
POD_ONLY_FILES = (
    ...
    "tests/pdf_processing/q04/pod_workload_c.py",
    "tests/pdf_processing/q04/pod_init_c.py",
    "tests/pdf_processing/q04/pod_remote_evidence_c.py",
