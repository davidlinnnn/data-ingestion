...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_ay_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/process-drain-pod-cgroup-20260925-ay/"
base.EVIDENCE_PVC = "q04-pod-cgroup-ay-evidence-20260925-ay"
base.EVIDENCE_DIRECTORY_NAME = "q04-process-drain-pod-cgroup-20260925-ay"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    "tests/pdf_processing/q04/candidate/process_drain_window_ay.py",
    ...
    "tests/pdf_processing/q04/pod_workload_ay.py",
    "tests/pdf_processing/q04/pod_preflight_ay.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_ay.py",
    "tests/pdf_processing/q04/pod_topology_ay.py",
    "tests/pdf_processing/q04/host_an.py",
    "tests/pdf_processing/q04/pod-topology-v50/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
