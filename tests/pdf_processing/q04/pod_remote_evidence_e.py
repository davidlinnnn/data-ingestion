...
STREAM_FILES = {
    "state/yolo-pod-cgroup-e-measurement/resource-attribution.jsonl",
    "vm-controller.jsonl",
    "workload.log",
}
FINAL_REQUIRED = {
    "state/yolo-pod-cgroup-e/phase-complete.json",
    "state/yolo-pod-cgroup-e/reviewed-window-contract.json",
    "state/yolo-pod-cgroup-e/fresh-index.json",
    "state/yolo-pod-cgroup-e/fresh-07/accepted.json",
    "state/yolo-pod-cgroup-e/fresh-07/document.json",
    "state/yolo-pod-cgroup-e/fresh-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-e/restored-07/accepted.json",
    "state/yolo-pod-cgroup-e/restored-07/document.json",
    "state/yolo-pod-cgroup-e/restored-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-e/replay-07/accepted.json",
    "state/yolo-pod-cgroup-e/replay-07/document.json",
    "state/yolo-pod-cgroup-e/replay-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-e-measurement/resource-attribution.jsonl",
    "state/yolo-pod-cgroup-e-measurement/resource-attribution-summary.json",
    "state/yolo-pod-cgroup-e-measurement/measurement-contract.json",
    "workload-exit.json",
...
ALLOWED_PREFIXES = (
    "state/yolo-pod-cgroup-e/",
    "state/yolo-pod-cgroup-e-measurement/",
)
