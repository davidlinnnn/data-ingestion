...
TOPOLOGY_PHASE = 'q04-pod-cgroup-bh'
RUN_ID = 'q04-pod-loss-pod-cgroup-20260926-bh'


def verify_workload_imports(*, workspace: Path, bundle: Path, prefix: str):
    modules = ('candidate.pod_loss_window_bh', 'pod_loss_bridge_bh',
               'pod_workload_bh', 'pod_init_p', 'worker_bc')
    for module in modules:
        importlib.import_module(module)
    from candidate.pod_loss_window_bh import validate_scope
    ...
    path = workspace / 'tests/pdf_processing/q04/pod-topology-v59/RUNTIME-INTEGRATION-MANIFEST.json'
