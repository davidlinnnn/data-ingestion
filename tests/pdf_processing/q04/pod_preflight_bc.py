...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_preflight_bc_engine", Path(__file__).with_name("pod_preflight_q.py")
)
...
TOPOLOGY_PHASE = "q04-pod-cgroup-bc"
RUN_ID = "q04-process-drain-pod-cgroup-20260925-bc"
...
def verify_workload_imports_at(*, workspace, bundle, prefix):
    modules = (
        "candidate.process_drain_window_bc",
        "pod_init_p",
        "pod_workload_bc",
        "pod_remote_evidence_bc",
        "host_bc",
        "worker_bc",
    )
    ...
    from candidate.process_drain_window_bc import validate_scope
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v54/RUNTIME-INTEGRATION-MANIFEST.json"
