...
import pod_topology_f as topology
import pod_remote_evidence_f as remote_evidence
import pod_workload_f as workload
from sentinel import run_yolo_pod_cgroup_f as runner


class YoloPodCgroupFRunnerTests(unittest.TestCase):
    ...
    def test_new_identity_and_paths_do_not_reuse_c(self):
        ...
        self.assertEqual(scope["run_identity"], "q04-yolo-pod-cgroup-20260920-f")
        self.assertEqual(scope["evidence_pvc"], "q04-pod-cgroup-f-evidence-20260920-f")
        self.assertEqual(
            scope["evidence_directory_name"], "q04-yolo-pod-cgroup-20260920-f"
        )
    ...
    def test_single_gate_set_precedes_workload_and_uses_staged_inputs(self):
        ...
        self.assertIn("pod_preflight_f.py", argv[1])
        self.assertEqual(
    ...
    def test_generated_manifests_and_offline_check_are_exact(self):
        ...
        self.assertEqual(
            json.loads((runner.Q04 / "pod-topology-v5/SOURCE-MANIFEST.json").read_text()),
