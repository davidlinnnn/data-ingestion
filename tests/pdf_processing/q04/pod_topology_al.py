...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_al_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/profile-pod-cgroup-20260924-al/"
base.EVIDENCE_PVC = "q04-pod-cgroup-al-evidence-20260924-al"
base.EVIDENCE_DIRECTORY_NAME = "q04-profile-pod-cgroup-20260924-al"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    "tests/pdf_processing/q04/candidate/profile_reuse_window_al.py",
    ...
    "tests/pdf_processing/q04/pod_workload_al.py",
    "tests/pdf_processing/q04/pod_preflight_al.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_al.py",
    "tests/pdf_processing/q04/pod_topology_al.py",
    "tests/pdf_processing/q04/pod-topology-v37/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
