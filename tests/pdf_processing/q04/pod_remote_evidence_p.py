...
STREAM_FILES = {
    "state/aima-pod-cgroup-p-measurement/resource-attribution.jsonl",
    "vm-controller.jsonl",
    "workload.log",
}
FINAL_REQUIRED = {
    "workload-memory-policy.json",
    "state/aima-pod-cgroup-p/phase-complete.json",
    "state/aima-pod-cgroup-p/reviewed-window-contract.json",
    "state/aima-pod-cgroup-p/fresh-index.json",
    "state/aima-pod-cgroup-p/fresh-08/accepted.json",
    "state/aima-pod-cgroup-p/fresh-08/document.json",
    "state/aima-pod-cgroup-p/fresh-08/source-image-supplement.json",
    "state/aima-pod-cgroup-p/restored-08/source-image-supplement.json",
    "state/aima-pod-cgroup-p/replay-08/source-image-supplement.json",
    "state/aima-pod-cgroup-p/restored-08/accepted.json",
    "state/aima-pod-cgroup-p/restored-08/document.json",
    "state/aima-pod-cgroup-p/replay-08/accepted.json",
    "state/aima-pod-cgroup-p/replay-08/document.json",
    "state/aima-pod-cgroup-p-measurement/resource-attribution.jsonl",
    "state/aima-pod-cgroup-p-measurement/resource-attribution-summary.json",
    "state/aima-pod-cgroup-p-measurement/measurement-contract.json",
    "workload-exit.json",
...
ALLOWED_PREFIXES = (
    "state/aima-pod-cgroup-p/",
    "state/aima-pod-cgroup-p-measurement/",
)
