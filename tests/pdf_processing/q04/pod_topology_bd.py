...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_bd_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/process-drain-pod-cgroup-20260925-bd/"
base.EVIDENCE_PVC = "q04-pod-cgroup-bd-evidence-20260925-bd"
base.EVIDENCE_DIRECTORY_NAME = "q04-process-drain-pod-cgroup-20260925-bd"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    "tests/pdf_processing/q04/candidate/process_drain_window_bd.py",
    ...
    "tests/pdf_processing/q04/pod_workload_bd.py",
    "tests/pdf_processing/q04/pod_preflight_bd.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_bd.py",
    "tests/pdf_processing/q04/pod_topology_bd.py",
    "tests/pdf_processing/q04/host_bc.py",
    "tests/pdf_processing/q04/worker_bc.py",
    "tests/pdf_processing/q04/pod-topology-v55/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
