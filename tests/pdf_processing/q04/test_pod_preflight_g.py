...
import pod_preflight_g as preflight
...
class PodPreflightGTests(unittest.TestCase):
    ...
    def test_single_preflight_returns_all_gates_without_starting_work(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            source_manifest.write_text(json.dumps({
                "phase": "q04-pod-cgroup-g", "producer": {}, "harness": {},
            ...
            evidence_directory.prepare_run_directory(
                mount,
                "q04-yolo-pod-cgroup-20260920-g",
            ...
            workload_imports.assert_called_once()
