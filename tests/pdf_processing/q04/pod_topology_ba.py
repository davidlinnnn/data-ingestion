...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_ba_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/process-drain-pod-cgroup-20260925-ba/"
base.EVIDENCE_PVC = "q04-pod-cgroup-ba-evidence-20260925-ba"
base.EVIDENCE_DIRECTORY_NAME = "q04-process-drain-pod-cgroup-20260925-ba"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    "tests/pdf_processing/q04/candidate/process_drain_window_ba.py",
    ...
    "tests/pdf_processing/q04/pod_workload_ba.py",
    "tests/pdf_processing/q04/pod_preflight_ba.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_ba.py",
    "tests/pdf_processing/q04/pod_topology_ba.py",
    "tests/pdf_processing/q04/host_an.py",
    "tests/pdf_processing/q04/pod-topology-v52/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
