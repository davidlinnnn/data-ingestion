...
PHASE = "q04-pod-cgroup-j"
DEPLOYMENT = PHASE + "-activities"
RUN_LABEL = PHASE
WORKFLOW_QUEUE = PHASE + "-workflows"
ACTIVITY_QUEUE = PHASE + "-07"
OBJECT_PREFIX = "q04/yolo-pod-cgroup-20260920-j/"
MEMORY_REQUEST = "4Gi"
MEMORY_LIMIT = "5Gi"
EPHEMERAL_REQUEST = "3Gi"
EPHEMERAL_LIMIT = "4Gi"
EVIDENCE_PVC = "q04-pod-cgroup-j-evidence-20260920-j"
EVIDENCE_DIRECTORY_NAME = "q04-yolo-pod-cgroup-20260920-j"
...
POD_ONLY_FILES = (
    ...
    "tests/pdf_processing/q04/pod_workload_j.py",
    "tests/pdf_processing/q04/pod_init_j.py",
    "tests/pdf_processing/q04/pod_remote_evidence_j.py",
    "tests/pdf_processing/q04/pod_durable_evidence.py",
    "tests/pdf_processing/q04/pod_evidence_directory_d.py",
    "tests/pdf_processing/q04/pod_preflight_j.py",
