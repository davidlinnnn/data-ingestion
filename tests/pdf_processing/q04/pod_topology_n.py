...
PHASE = "q04-pod-cgroup-n"
DEPLOYMENT = PHASE + "-activities"
RUN_LABEL = PHASE
WORKFLOW_QUEUE = PHASE + "-workflows"
ACTIVITY_QUEUE = PHASE + "-08"
OBJECT_PREFIX = "q04/aima-pod-cgroup-20260920-n/"
MEMORY_REQUEST = "4Gi"
MEMORY_LIMIT = "5Gi"
EPHEMERAL_REQUEST = "3Gi"
EPHEMERAL_LIMIT = "4Gi"
EVIDENCE_PVC = "q04-pod-cgroup-n-evidence-20260920-n"
EVIDENCE_DIRECTORY_NAME = "q04-aima-pod-cgroup-20260920-n"
...
POD_ONLY_FILES = (
    "tests/pdf_processing/q04/candidate/aima_pod_window.py",
    ...
    "tests/pdf_processing/q04/pod_workload_n.py",
    "tests/pdf_processing/q04/pod_init_n.py",
    "tests/pdf_processing/q04/pod_remote_evidence_n.py",
    "tests/pdf_processing/q04/pod_durable_evidence.py",
    "tests/pdf_processing/q04/pod_evidence_directory_d.py",
    "tests/pdf_processing/q04/pod_preflight_n.py",
