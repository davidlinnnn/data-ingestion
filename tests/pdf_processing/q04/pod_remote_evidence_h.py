...
STREAM_FILES = {
    "state/yolo-pod-cgroup-h-measurement/resource-attribution.jsonl",
    "vm-controller.jsonl",
    "workload.log",
}
FINAL_REQUIRED = {
    "state/yolo-pod-cgroup-h/phase-complete.json",
    "state/yolo-pod-cgroup-h/reviewed-window-contract.json",
    "state/yolo-pod-cgroup-h/fresh-index.json",
    "state/yolo-pod-cgroup-h/fresh-07/accepted.json",
    "state/yolo-pod-cgroup-h/fresh-07/document.json",
    "state/yolo-pod-cgroup-h/fresh-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-h/restored-07/accepted.json",
    "state/yolo-pod-cgroup-h/restored-07/document.json",
    "state/yolo-pod-cgroup-h/restored-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-h/replay-07/accepted.json",
    "state/yolo-pod-cgroup-h/replay-07/document.json",
    "state/yolo-pod-cgroup-h/replay-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-h-measurement/resource-attribution.jsonl",
    "state/yolo-pod-cgroup-h-measurement/resource-attribution-summary.json",
    "state/yolo-pod-cgroup-h-measurement/measurement-contract.json",
    "workload-exit.json",
...
ALLOWED_PREFIXES = (
    "state/yolo-pod-cgroup-h/",
    "state/yolo-pod-cgroup-h-measurement/",
)
