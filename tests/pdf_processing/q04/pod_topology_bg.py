...
_spec = importlib.util.spec_from_file_location(
    'q04_pod_topology_bg_engine', Path(__file__).with_name('pod_topology_p.py'))
base = importlib.util.module_from_spec(_spec)
sys.modules[_spec.name] = base
_spec.loader.exec_module(base)

base.PHASE = 'q04-pod-cgroup-bg'
...
base.OBJECT_PREFIX = 'q04/pod-loss-pod-cgroup-20260925-bg/'
base.EVIDENCE_PVC = 'q04-pod-cgroup-bg-evidence-20260925-bg'
base.EVIDENCE_DIRECTORY_NAME = 'q04-pod-loss-pod-cgroup-20260925-bg'
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(be.base.POD_ONLY_FILES + (
    'tests/pdf_processing/q04/candidate/pod_loss_window_bg.py',
    'tests/pdf_processing/q04/pod_loss_bridge_bg.py',
    'tests/pdf_processing/q04/pod_workload_bg.py',
    'tests/pdf_processing/q04/pod_activity_supervisor_bg.py',
    'tests/pdf_processing/q04/pod_preflight_bg.py',
    'tests/pdf_processing/q04/pod_topology_bg.py',
    'tests/pdf_processing/q04/pod-topology-v58/RUNTIME-INTEGRATION-MANIFEST.json',
)))
