...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_preflight_ag_engine", Path(__file__).with_name("pod_preflight_q.py")
)
...
TOPOLOGY_PHASE = "q04-pod-cgroup-ag"
RUN_ID = "q04-warm-pod-cgroup-20260922-ag"
sha256 = base.base.sha256


def verify_configuration_ag(**kwargs):
...
def verify_workload_imports_ag(*, workspace, bundle, prefix):
    modules = (
        "candidate.warm_pod_window_r",
        "pod_init_p",
        "pod_workload_ag",
        "pod_remote_evidence_ag",
    )
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v32/RUNTIME-INTEGRATION-MANIFEST.json"
...
base.RUN_ID = RUN_ID
base.verify_configuration_q = verify_configuration_ag
base.verify_workload_imports_q = verify_workload_imports_ag
main = base.main
