...
PHASE = "q04-pod-cgroup-p"
DEPLOYMENT = PHASE + "-activities"
RUN_LABEL = PHASE
WORKFLOW_QUEUE = PHASE + "-workflows"
ACTIVITY_QUEUE = PHASE + "-08"
OBJECT_PREFIX = "q04/aima-pod-cgroup-20260920-p/"
MEMORY_REQUEST = "4Gi"
MEMORY_LIMIT = "5Gi"
EPHEMERAL_REQUEST = "3Gi"
EPHEMERAL_LIMIT = "4Gi"
EVIDENCE_PVC = "q04-pod-cgroup-p-evidence-20260920-p"
EVIDENCE_DIRECTORY_NAME = "q04-aima-pod-cgroup-20260920-p"
...
POD_ONLY_FILES = (
    ...
    "tests/pdf_processing/q04/candidate/aima_pod_window_o.py",
    "tests/pdf_processing/q04/candidate/aima_image_supplement.py",
    "tests/pdf_processing/q04/sentinel/aima_attribution_telemetry_o.py",
    ...
    "tests/pdf_processing/q04/pod_workload_p.py",
    "tests/pdf_processing/q04/pod_init_p.py",
    "tests/pdf_processing/q04/pod_remote_evidence_p.py",
    "tests/pdf_processing/q04/pod_durable_evidence.py",
    "tests/pdf_processing/q04/pod_evidence_directory_d.py",
    "tests/pdf_processing/q04/pod_preflight_p.py",
    ...
    deployment = {
        ...
        "metadata": {
            ...
            "annotations": {
                ...
                "q04.openai/evidence-directory": EVIDENCE_DIRECTORY_NAME,
...
def validate(value: dict[str, Any]) -> dict[str, Any]:
    ...
    if deployment["metadata"]["annotations"].get(
        "q04.openai/evidence-directory"
    ) != EVIDENCE_DIRECTORY_NAME:
        raise ValueError("run-owned evidence directory changed")
