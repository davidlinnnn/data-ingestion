...
def verify_reviewed_contract(*, workspace: Path, bundle: Path, prefix: str) -> dict:
    ...
    path = workspace / 'tests/pdf_processing/q04/pod-topology-v15/RUNTIME-INTEGRATION-MANIFEST.json'
    ...
    validate_scope(argparse.Namespace(integration_manifest=path,
        ...
        name='aima-pod-cgroup-p', expected_run_id='q04-aima-pod-cgroup-20260920-p',
...
def verify_configuration(
    *,
    ...
    if source_manifest.get("phase") != "q04-pod-cgroup-p":
    ...
    *,
    ...
    capture(
        ...
        lambda: verify_configuration(
            ...
            expected_phase="aima-pod-cgroup-p",
        )[1],
    )
    capture(
        "source_hashes",
