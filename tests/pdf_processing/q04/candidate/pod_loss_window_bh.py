...
def validate_workflow_budget(config):
    require(config['trial_seconds'] == 300,
            'BH workflow execution budget changed')
    return config['trial_seconds']
...
async def run_window(args):
    ...
    validate_workflow_budget(config)
