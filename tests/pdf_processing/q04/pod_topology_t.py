"""Render Q's inactive Pod topology with T's warm identity."""
...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_t_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/warm-pod-cgroup-20260921-t/"
base.EVIDENCE_PVC = "q04-pod-cgroup-t-evidence-20260921-t"
base.EVIDENCE_DIRECTORY_NAME = "q04-warm-pod-cgroup-20260921-t"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    ...
    "tests/pdf_processing/q04/pod_workload_t.py",
    "tests/pdf_processing/q04/pod_preflight_t.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_t.py",
    "tests/pdf_processing/q04/pod_topology_t.py",
    "tests/pdf_processing/q04/pod-topology-v19/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
