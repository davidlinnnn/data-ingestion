...
STREAM_FILES = {
    "state/yolo-pod-cgroup-g-measurement/resource-attribution.jsonl",
    "vm-controller.jsonl",
    "workload.log",
}
FINAL_REQUIRED = {
    "state/yolo-pod-cgroup-g/phase-complete.json",
    "state/yolo-pod-cgroup-g/reviewed-window-contract.json",
    "state/yolo-pod-cgroup-g/fresh-index.json",
    "state/yolo-pod-cgroup-g/fresh-07/accepted.json",
    "state/yolo-pod-cgroup-g/fresh-07/document.json",
    "state/yolo-pod-cgroup-g/fresh-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-g/restored-07/accepted.json",
    "state/yolo-pod-cgroup-g/restored-07/document.json",
    "state/yolo-pod-cgroup-g/restored-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-g/replay-07/accepted.json",
    "state/yolo-pod-cgroup-g/replay-07/document.json",
    "state/yolo-pod-cgroup-g/replay-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-g-measurement/resource-attribution.jsonl",
    "state/yolo-pod-cgroup-g-measurement/resource-attribution-summary.json",
    "state/yolo-pod-cgroup-g-measurement/measurement-contract.json",
    "workload-exit.json",
...
ALLOWED_PREFIXES = (
    "state/yolo-pod-cgroup-g/",
    "state/yolo-pod-cgroup-g-measurement/",
)
