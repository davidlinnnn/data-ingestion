...
STREAM_FILES = {
    "state/yolo-pod-cgroup-i-measurement/resource-attribution.jsonl",
    "vm-controller.jsonl",
    "workload.log",
}
FINAL_REQUIRED = {
    "state/yolo-pod-cgroup-i/phase-complete.json",
    "state/yolo-pod-cgroup-i/reviewed-window-contract.json",
    "state/yolo-pod-cgroup-i/fresh-index.json",
    "state/yolo-pod-cgroup-i/fresh-07/accepted.json",
    "state/yolo-pod-cgroup-i/fresh-07/document.json",
    "state/yolo-pod-cgroup-i/fresh-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-i/restored-07/accepted.json",
    "state/yolo-pod-cgroup-i/restored-07/document.json",
    "state/yolo-pod-cgroup-i/restored-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-i/replay-07/accepted.json",
    "state/yolo-pod-cgroup-i/replay-07/document.json",
    "state/yolo-pod-cgroup-i/replay-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-i-measurement/resource-attribution.jsonl",
    "state/yolo-pod-cgroup-i-measurement/resource-attribution-summary.json",
    "state/yolo-pod-cgroup-i-measurement/measurement-contract.json",
    "workload-exit.json",
...
ALLOWED_PREFIXES = (
    "state/yolo-pod-cgroup-i/",
    "state/yolo-pod-cgroup-i-measurement/",
)
