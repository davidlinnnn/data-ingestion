...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_ar_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/relationship-pod-cgroup-20260925-ar/"
base.EVIDENCE_PVC = "q04-pod-cgroup-ar-evidence-20260925-ar"
base.EVIDENCE_DIRECTORY_NAME = "q04-relationship-pod-cgroup-20260925-ar"
...
def _traced_kubernetes_list():
    ...
    container["env"].append({
        ...
        "value": "/q04-evidence/" + base.EVIDENCE_DIRECTORY_NAME
                 + "/state/relationship-pod-cgroup-ar/ocr-trace",
    })
    return topology


base.kubernetes_list = _traced_kubernetes_list
_source_data = base._source_data


def _traced_source_data():
    producer, harness = _source_data()
    producer["ocr.py"] = (base.Q04 / "pod-topology-v43/ocr.py").read_text()
    return producer, harness


base._source_data = _traced_source_data
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    ...
    "tests/pdf_processing/q04/pod-topology-v43/ocr.py",
    ...
    "tests/pdf_processing/q04/pod_workload_ar.py",
    "tests/pdf_processing/q04/pod_preflight_ar.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_ar.py",
    "tests/pdf_processing/q04/pod_topology_ar.py",
    ...
    "tests/pdf_processing/q04/pod-topology-v43/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
