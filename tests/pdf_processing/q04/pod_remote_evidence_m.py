...
STREAM_FILES = {
    "state/yolo-pod-cgroup-m-measurement/resource-attribution.jsonl",
    "vm-controller.jsonl",
    "workload.log",
}
FINAL_REQUIRED = {
    ...
    "state/yolo-pod-cgroup-m/fresh-07/accepted.json",
    "state/yolo-pod-cgroup-m/fresh-07/document.json",
    "state/yolo-pod-cgroup-m/fresh-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-m/restored-07/accepted.json",
    "state/yolo-pod-cgroup-m/restored-07/document.json",
    "state/yolo-pod-cgroup-m/restored-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-m/replay-07/accepted.json",
    "state/yolo-pod-cgroup-m/replay-07/document.json",
    "state/yolo-pod-cgroup-m/replay-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-m-measurement/resource-attribution.jsonl",
    "state/yolo-pod-cgroup-m-measurement/resource-attribution-summary.json",
    "state/yolo-pod-cgroup-m-measurement/measurement-contract.json",
    "workload-exit.json",
...
ALLOWED_PREFIXES = (
    "state/yolo-pod-cgroup-m/",
    "state/yolo-pod-cgroup-m-measurement/",
)
