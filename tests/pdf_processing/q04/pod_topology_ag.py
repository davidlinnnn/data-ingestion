"""Render Q's inactive Pod topology with AG's warm identity."""
...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_ag_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/warm-pod-cgroup-20260922-ag/"
base.EVIDENCE_PVC = "q04-pod-cgroup-ag-evidence-20260922-ag"
base.EVIDENCE_DIRECTORY_NAME = "q04-warm-pod-cgroup-20260922-ag"
base.PRODUCER_MANIFEST = base.Q04 / "candidate/warm-lifecycle-ag/MANIFEST.json"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    ...
    "tests/pdf_processing/q04/candidate/warm-lifecycle-ag/MANIFEST.json",
    "tests/pdf_processing/q04/candidate/yolo-equivalence-v2/ADOPTION.json",
    "tests/pdf_processing/q04/pod_workload_ag.py",
    "tests/pdf_processing/q04/pod_preflight_ag.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_ag.py",
    "tests/pdf_processing/q04/pod_topology_ag.py",
    "tests/pdf_processing/q04/pod-topology-v32/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
