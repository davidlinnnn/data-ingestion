...
STREAM_FILES = {
    "state/aima-pod-cgroup-n-measurement/resource-attribution.jsonl",
    "vm-controller.jsonl",
    "workload.log",
}
FINAL_REQUIRED = {
    "workload-memory-policy.json",
    "state/aima-pod-cgroup-n/phase-complete.json",
    "state/aima-pod-cgroup-n/reviewed-window-contract.json",
    "state/aima-pod-cgroup-n/fresh-index.json",
    "state/aima-pod-cgroup-n/fresh-08/accepted.json",
    "state/aima-pod-cgroup-n/fresh-08/document.json",
    "state/aima-pod-cgroup-n/restored-08/accepted.json",
    "state/aima-pod-cgroup-n/restored-08/document.json",
    "state/aima-pod-cgroup-n/replay-08/accepted.json",
    "state/aima-pod-cgroup-n/replay-08/document.json",
    "state/aima-pod-cgroup-n-measurement/resource-attribution.jsonl",
    "state/aima-pod-cgroup-n-measurement/resource-attribution-summary.json",
    "state/aima-pod-cgroup-n-measurement/measurement-contract.json",
    "workload-exit.json",
...
ALLOWED_PREFIXES = (
    "state/aima-pod-cgroup-n/",
    "state/aima-pod-cgroup-n-measurement/",
)
