...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_preflight_aa_engine", Path(__file__).with_name("pod_preflight_q.py")
)
...
TOPOLOGY_PHASE = "q04-pod-cgroup-aa"
RUN_ID = "q04-warm-pod-cgroup-20260921-aa"
sha256 = base.base.sha256


def verify_configuration_aa(**kwargs):
...
def verify_workload_imports_aa(*, workspace, bundle, prefix):
    modules = (
        "candidate.warm_pod_window_r",
        "pod_init_p",
        "pod_workload_aa",
        "pod_remote_evidence_aa",
    )
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v26/RUNTIME-INTEGRATION-MANIFEST.json"
...
base.RUN_ID = RUN_ID
base.verify_configuration_q = verify_configuration_aa
base.verify_workload_imports_q = verify_workload_imports_aa
main = base.main
