"""S pre-inference gates for the corrected Q04 warm sequence."""
...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_preflight_s_engine", Path(__file__).with_name("pod_preflight_q.py")
)
...
TOPOLOGY_PHASE = "q04-pod-cgroup-s"
RUN_ID = "q04-warm-pod-cgroup-20260921-s"
sha256 = base.base.sha256


def verify_configuration_s(**kwargs):
...
def verify_workload_imports_s(*, workspace, bundle, prefix):
    modules = (
        "candidate.warm_pod_window_r",
        "pod_init_p",
        "pod_workload_s",
        "pod_remote_evidence_s",
    )
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v18/RUNTIME-INTEGRATION-MANIFEST.json"
...
base.RUN_ID = RUN_ID
base.verify_configuration_q = verify_configuration_s
base.verify_workload_imports_q = verify_workload_imports_s
main = base.main
