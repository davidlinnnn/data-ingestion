...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_ak_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/profile-pod-cgroup-20260924-ak/"
base.EVIDENCE_PVC = "q04-pod-cgroup-ak-evidence-20260924-ak"
base.EVIDENCE_DIRECTORY_NAME = "q04-profile-pod-cgroup-20260924-ak"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    "tests/pdf_processing/q04/candidate/profile_rejection_window_ak.py",
    ...
    "tests/pdf_processing/q04/pod_workload_ak.py",
    "tests/pdf_processing/q04/pod_preflight_ak.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_ak.py",
    "tests/pdf_processing/q04/pod_topology_ak.py",
    "tests/pdf_processing/q04/pod-topology-v36/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
