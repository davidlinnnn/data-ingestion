...
import pod_topology_aq as pod_topology
from pod_remote_evidence_aq import (
    FINAL_REQUIRED,
...
PHASE = "relationship-pod-cgroup-aq"
RUN_IDENTITY = "q04-relationship-pod-cgroup-20260925-aq"
PREFIX = "q04/relationship-pod-cgroup-20260925-aq/"
OUT = Path("/private/tmp/q04-relationship-pod-cgroup-20260925-aq")
...
WORKER_YAML = base.Q04 / "pod-topology-v42/WORKER.yaml"
OFFLINE_MANIFEST = base.Q04 / "pod-topology-v42/RUNNER-MANIFEST.json"
...
def workload_argv() -> list[str]:
    return [
        ...
        "/workspace/tests/pdf_processing/q04/pod_workload_aq.py",
        "--prefix", PREFIX,
...
def preflight_argv() -> list[str]:
    return [
        "/experiment/.venv/bin/python",
        "/workspace/tests/pdf_processing/q04/pod_preflight_aq.py",
        "--workspace", "/workspace",
...
def build_offline_manifest() -> dict:
    ...
    paths = {
        ...
        "pod_workload": base.Q04 / "pod_workload_aq.py",
        "remote_evidence": base.Q04 / "pod_remote_evidence_aq.py",
        "pre_inference": base.Q04 / "pod_preflight_aq.py",
        "topology_builder": base.Q04 / "pod_topology_aq.py",
        "matrix_window": base.Q04 / "candidate/relationship_interruption_window_ao.py",
        "source_manifest": base.Q04 / "pod-topology-v42/SOURCE-MANIFEST.json",
        "runtime_integration_manifest": base.Q04 / "pod-topology-v42/RUNTIME-INTEGRATION-MANIFEST.json",
        "node_pressure_observer": Path(__file__).with_name("node_pressure_attribution.py"),
        "node_pressure_guard": Path(__file__).with_name("run_relationship_pod_cgroup_aq_guarded.py"),
    }
