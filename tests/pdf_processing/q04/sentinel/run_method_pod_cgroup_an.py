...
import pod_topology_an as pod_topology
from pod_remote_evidence_an import (
    FINAL_REQUIRED,
...
PHASE = "method-pod-cgroup-an"
RUN_IDENTITY = "q04-method-pod-cgroup-20260924-an"
PREFIX = "q04/method-pod-cgroup-20260924-an/"
OUT = Path("/private/tmp/q04-method-pod-cgroup-20260924-an")
...
WORKER_YAML = base.Q04 / "pod-topology-v39/WORKER.yaml"
OFFLINE_MANIFEST = base.Q04 / "pod-topology-v39/RUNNER-MANIFEST.json"
...
def workload_argv() -> list[str]:
    return [
        ...
        "/workspace/tests/pdf_processing/q04/pod_workload_an.py",
        "--prefix", PREFIX,
...
def preflight_argv() -> list[str]:
    return [
        "/experiment/.venv/bin/python",
        "/workspace/tests/pdf_processing/q04/pod_preflight_an.py",
        "--workspace", "/workspace",
...
def build_offline_manifest() -> dict:
    ...
    paths = {
        ...
        "pod_workload": base.Q04 / "pod_workload_an.py",
        "remote_evidence": base.Q04 / "pod_remote_evidence_an.py",
        "pre_inference": base.Q04 / "pod_preflight_an.py",
        "topology_builder": base.Q04 / "pod_topology_an.py",
        "matrix_window": base.Q04 / "candidate/method_invalidation_window_an.py",
        "source_manifest": base.Q04 / "pod-topology-v39/SOURCE-MANIFEST.json",
        "runtime_integration_manifest": base.Q04 / "pod-topology-v39/RUNTIME-INTEGRATION-MANIFEST.json",
    }
    value["sources"].update({
        name: base.sha256(path.read_bytes()) for name, path in paths.items()
    })
    value["runtime_blocker"] = "live admission and complete AM method-invalidation runtime gates"
    return value
