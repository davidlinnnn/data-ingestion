...
import pod_topology_ao as pod_topology
from pod_remote_evidence_ao import (
    FINAL_REQUIRED,
...
RUN_IDENTITY = "q04-relationship-pod-cgroup-20260924-ao"
PREFIX = "q04/relationship-pod-cgroup-20260924-ao/"
OUT = Path("/private/tmp/q04-relationship-pod-cgroup-20260924-ao")
...
WORKER_YAML = base.Q04 / "pod-topology-v40/WORKER.yaml"
OFFLINE_MANIFEST = base.Q04 / "pod-topology-v40/RUNNER-MANIFEST.json"
...
def workload_argv() -> list[str]:
    return [
        ...
        "/workspace/tests/pdf_processing/q04/pod_workload_ao.py",
        "--prefix", PREFIX,
...
def preflight_argv() -> list[str]:
    return [
        "/experiment/.venv/bin/python",
        "/workspace/tests/pdf_processing/q04/pod_preflight_ao.py",
        "--workspace", "/workspace",
...
def build_offline_manifest() -> dict:
    ...
    paths = {
        ...
        "pod_workload": base.Q04 / "pod_workload_ao.py",
        "remote_evidence": base.Q04 / "pod_remote_evidence_ao.py",
        "pre_inference": base.Q04 / "pod_preflight_ao.py",
        "topology_builder": base.Q04 / "pod_topology_ao.py",
        "matrix_window": base.Q04 / "candidate/relationship_interruption_window_ao.py",
        "source_manifest": base.Q04 / "pod-topology-v40/SOURCE-MANIFEST.json",
        "runtime_integration_manifest": base.Q04 / "pod-topology-v40/RUNTIME-INTEGRATION-MANIFEST.json",
    }
