...
import pod_topology_am as pod_topology
from pod_remote_evidence_am import (
    FINAL_REQUIRED,
...
PHASE = "method-pod-cgroup-am"
RUN_IDENTITY = "q04-method-pod-cgroup-20260924-am"
PREFIX = "q04/method-pod-cgroup-20260924-am/"
OUT = Path("/private/tmp/q04-method-pod-cgroup-20260924-am")
...
WORKER_YAML = base.Q04 / "pod-topology-v38/WORKER.yaml"
OFFLINE_MANIFEST = base.Q04 / "pod-topology-v38/RUNNER-MANIFEST.json"
...
def workload_argv() -> list[str]:
    return [
        ...
        "/workspace/tests/pdf_processing/q04/pod_workload_am.py",
        "--prefix", PREFIX,
...
def preflight_argv() -> list[str]:
    return [
        "/experiment/.venv/bin/python",
        "/workspace/tests/pdf_processing/q04/pod_preflight_am.py",
        "--workspace", "/workspace",
...
def build_offline_manifest() -> dict:
    ...
    paths = {
        ...
        "pod_workload": base.Q04 / "pod_workload_am.py",
        "remote_evidence": base.Q04 / "pod_remote_evidence_am.py",
        "pre_inference": base.Q04 / "pod_preflight_am.py",
        "topology_builder": base.Q04 / "pod_topology_am.py",
        "matrix_window": base.Q04 / "candidate/method_invalidation_window_am.py",
        "source_manifest": base.Q04 / "pod-topology-v38/SOURCE-MANIFEST.json",
        "runtime_integration_manifest": base.Q04 / "pod-topology-v38/RUNTIME-INTEGRATION-MANIFEST.json",
    }
