...
import pod_topology_ap as pod_topology
from pod_remote_evidence_ap import (
    FINAL_REQUIRED,
...
PHASE = "relationship-pod-cgroup-ap"
RUN_IDENTITY = "q04-relationship-pod-cgroup-20260925-ap"
PREFIX = "q04/relationship-pod-cgroup-20260925-ap/"
OUT = Path("/private/tmp/q04-relationship-pod-cgroup-20260925-ap")
...
WORKER_YAML = base.Q04 / "pod-topology-v41/WORKER.yaml"
OFFLINE_MANIFEST = base.Q04 / "pod-topology-v41/RUNNER-MANIFEST.json"
...
def workload_argv() -> list[str]:
    return [
        ...
        "/workspace/tests/pdf_processing/q04/pod_workload_ap.py",
        "--prefix", PREFIX,
...
def preflight_argv() -> list[str]:
    return [
        "/experiment/.venv/bin/python",
        "/workspace/tests/pdf_processing/q04/pod_preflight_ap.py",
        "--workspace", "/workspace",
...
def exact_command() -> str:
    return shlex.join([
        ...
        str(Path(__file__).with_name("run_relationship_pod_cgroup_ap_guarded.py").resolve()),
        "--execute",
        "--owner", "main-session",
...
def build_offline_manifest() -> dict:
    ...
    paths = {
        ...
        "pod_workload": base.Q04 / "pod_workload_ap.py",
        "remote_evidence": base.Q04 / "pod_remote_evidence_ap.py",
        "pre_inference": base.Q04 / "pod_preflight_ap.py",
        "topology_builder": base.Q04 / "pod_topology_ap.py",
        "matrix_window": base.Q04 / "candidate/relationship_interruption_window_ao.py",
        "source_manifest": base.Q04 / "pod-topology-v41/SOURCE-MANIFEST.json",
        "runtime_integration_manifest": base.Q04 / "pod-topology-v41/RUNTIME-INTEGRATION-MANIFEST.json",
        "node_pressure_observer": Path(__file__).with_name("node_pressure_attribution.py"),
        "node_pressure_guard": Path(__file__).with_name("run_relationship_pod_cgroup_ap_guarded.py"),
    }
