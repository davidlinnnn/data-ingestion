...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_preflight_ah_engine", Path(__file__).with_name("pod_preflight_q.py")
)
...
TOPOLOGY_PHASE = "q04-pod-cgroup-ah"
RUN_ID = "q04-warm-pod-cgroup-20260924-ah"
sha256 = base.base.sha256


def verify_configuration_ah(**kwargs):
...
def verify_workload_imports_ah(*, workspace, bundle, prefix):
    modules = (
        "candidate.warm_pod_window_v3",
        "pod_init_p",
        "pod_workload_ah",
        "pod_remote_evidence_ah",
    )
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v33/RUNTIME-INTEGRATION-MANIFEST.json"
...
base.RUN_ID = RUN_ID
base.verify_configuration_q = verify_configuration_ah
base.verify_workload_imports_q = verify_workload_imports_ah
main = base.main
