...
| current | 310 tests; 0 failures, 3 identical errors | The historical test now compares the unchanged manifest to an exact retained copy of the source selected by commit `1d72b0c`; its SHA-256 is `3dc682ea2aeea9cbcee62a2e83193358179b8892f3c8eb330896a0d4cf6f3982`. The same three sandbox errors remain. |
...
The fixture-07 reviewed offline suite is independently green at 97/97. The new
topology, transport and runner tests are green at 28/28; the combined focused
set including the corrected historical runner test is green at 40/40.
