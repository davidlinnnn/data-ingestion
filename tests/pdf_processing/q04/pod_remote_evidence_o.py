...
STREAM_FILES = {
    "state/aima-pod-cgroup-o-measurement/resource-attribution.jsonl",
    "vm-controller.jsonl",
    "workload.log",
}
FINAL_REQUIRED = {
    "workload-memory-policy.json",
    "state/aima-pod-cgroup-o/phase-complete.json",
    "state/aima-pod-cgroup-o/reviewed-window-contract.json",
    "state/aima-pod-cgroup-o/fresh-index.json",
    "state/aima-pod-cgroup-o/fresh-08/accepted.json",
    "state/aima-pod-cgroup-o/fresh-08/document.json",
    "state/aima-pod-cgroup-o/fresh-08/source-image-supplement.json",
    "state/aima-pod-cgroup-o/restored-08/source-image-supplement.json",
    "state/aima-pod-cgroup-o/replay-08/source-image-supplement.json",
    "state/aima-pod-cgroup-o/restored-08/accepted.json",
    "state/aima-pod-cgroup-o/restored-08/document.json",
    "state/aima-pod-cgroup-o/replay-08/accepted.json",
    "state/aima-pod-cgroup-o/replay-08/document.json",
    "state/aima-pod-cgroup-o-measurement/resource-attribution.jsonl",
    "state/aima-pod-cgroup-o-measurement/resource-attribution-summary.json",
    "state/aima-pod-cgroup-o-measurement/measurement-contract.json",
    "workload-exit.json",
...
ALLOWED_PREFIXES = (
    "state/aima-pod-cgroup-o/",
    "state/aima-pod-cgroup-o-measurement/",
)
