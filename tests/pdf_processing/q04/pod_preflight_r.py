"""R pre-inference gates for the original Q04 warm sequence."""
...
_spec = importlib.util.spec_from_file_location("q04_pod_preflight_r_engine", Path(__file__).with_name("pod_preflight_q.py"))
...
TOPOLOGY_PHASE = "q04-pod-cgroup-r"
RUN_ID = "q04-warm-pod-cgroup-20260921-r"


def verify_configuration_r(**kwargs):
...
def verify_workload_imports_r(*, workspace, bundle, prefix):
    modules = (
        "candidate.warm_pod_window_r",
        "pod_init_p",
        "pod_workload_r",
        "pod_remote_evidence_r",
    )
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v17/RUNTIME-INTEGRATION-MANIFEST.json"
...
base.RUN_ID = RUN_ID
base.verify_configuration_q = verify_configuration_r
base.verify_workload_imports_q = verify_workload_imports_r
main = base.main
