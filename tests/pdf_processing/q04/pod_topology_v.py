"""Render Q's inactive Pod topology with V's warm identity."""
...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_v_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/warm-pod-cgroup-20260921-v/"
base.EVIDENCE_PVC = "q04-pod-cgroup-v-evidence-20260921-v"
base.EVIDENCE_DIRECTORY_NAME = "q04-warm-pod-cgroup-20260921-v"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    ...
    "tests/pdf_processing/q04/pod_workload_v.py",
    "tests/pdf_processing/q04/pod_preflight_v.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_v.py",
    "tests/pdf_processing/q04/pod_topology_v.py",
    "tests/pdf_processing/q04/pod-topology-v21/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
