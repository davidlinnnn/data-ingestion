...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_ab_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/warm-pod-cgroup-20260921-ab/"
base.EVIDENCE_PVC = "q04-pod-cgroup-ab-evidence-20260921-ab"
base.EVIDENCE_DIRECTORY_NAME = "q04-warm-pod-cgroup-20260921-ab"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    ...
    "tests/pdf_processing/q04/candidate/warm-lifecycle-ab/MANIFEST.json",
    "tests/pdf_processing/q04/candidate/yolo-equivalence-v2/ADOPTION.json",
    "tests/pdf_processing/q04/pod_workload_ab.py",
    "tests/pdf_processing/q04/pod_preflight_ab.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_ab.py",
    "tests/pdf_processing/q04/pod_topology_ab.py",
    "tests/pdf_processing/q04/pod-topology-v27/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
