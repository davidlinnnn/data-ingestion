"""Render Q's inactive Pod topology with U's warm identity."""
...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_topology_u_engine", Path(__file__).with_name("pod_topology_p.py")
)
...
base.OBJECT_PREFIX = "q04/warm-pod-cgroup-20260921-u/"
base.EVIDENCE_PVC = "q04-pod-cgroup-u-evidence-20260921-u"
base.EVIDENCE_DIRECTORY_NAME = "q04-warm-pod-cgroup-20260921-u"
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(base.POD_ONLY_FILES + (
    ...
    "tests/pdf_processing/q04/pod_workload_u.py",
    "tests/pdf_processing/q04/pod_preflight_u.py",
    "tests/pdf_processing/q04/pod_preflight_q.py",
    "tests/pdf_processing/q04/pod_remote_evidence_u.py",
    "tests/pdf_processing/q04/pod_topology_u.py",
    "tests/pdf_processing/q04/pod-topology-v20/RUNTIME-INTEGRATION-MANIFEST.json",
)))
base.HARNESS_FILES = {
    name: base.ROOT / name
