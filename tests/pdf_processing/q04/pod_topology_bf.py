...
_spec = importlib.util.spec_from_file_location(
    'q04_pod_topology_bf_engine', Path(__file__).with_name('pod_topology_p.py'))
base = importlib.util.module_from_spec(_spec)
sys.modules[_spec.name] = base
_spec.loader.exec_module(base)

base.PHASE = 'q04-pod-cgroup-bf'
...
base.OBJECT_PREFIX = 'q04/pod-loss-pod-cgroup-20260925-bf/'
base.EVIDENCE_PVC = 'q04-pod-cgroup-bf-evidence-20260925-bf'
base.EVIDENCE_DIRECTORY_NAME = 'q04-pod-loss-pod-cgroup-20260925-bf'
...
base.POD_ONLY_FILES = tuple(dict.fromkeys(be.base.POD_ONLY_FILES + (
    'tests/pdf_processing/q04/candidate/pod_loss_window_bf.py',
    'tests/pdf_processing/q04/pod_loss_bridge_bf.py',
    'tests/pdf_processing/q04/pod_workload_bf.py',
    'tests/pdf_processing/q04/pod_activity_supervisor_bf.py',
    'tests/pdf_processing/q04/pod_preflight_bf.py',
    'tests/pdf_processing/q04/pod_topology_bf.py',
    'tests/pdf_processing/q04/pod-topology-v57/RUNTIME-INTEGRATION-MANIFEST.json',
)))
