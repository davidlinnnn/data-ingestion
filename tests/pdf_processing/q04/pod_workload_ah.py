...
WORKFLOW_QUEUE = "q04-pod-cgroup-ah-workflows"
ACTIVITY_QUEUE = "q04-pod-cgroup-ah-08"
EVIDENCE_ROOT = Path("/q04-evidence/q04-warm-pod-cgroup-20260924-ah")


def build_measurement_argv(args, run_id: str, authorization_sha256: str) -> list[str]:
    return [
        args.python,
        "-m", "candidate.warm_pod_window_v3",
        ...
        str(args.workspace / "tests/pdf_processing/q04/pod-topology-v33/RUNTIME-INTEGRATION-MANIFEST.json"),
...
def adapt_run():
    ...
    source = source.replace(
        old, "pod-topology-v33/RUNTIME-INTEGRATION-MANIFEST.json"
    )
