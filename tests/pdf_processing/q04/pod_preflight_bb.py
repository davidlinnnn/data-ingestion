...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_preflight_bb_engine", Path(__file__).with_name("pod_preflight_q.py")
)
...
TOPOLOGY_PHASE = "q04-pod-cgroup-bb"
...
def verify_workload_imports_at(*, workspace, bundle, prefix):
    modules = (
        "candidate.process_drain_window_bb",
        "pod_init_p",
        "pod_workload_bb",
        "pod_remote_evidence_bb",
        "host_an",
        "worker",
    )
    ...
    from candidate.process_drain_window_bb import validate_scope
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v53/RUNTIME-INTEGRATION-MANIFEST.json"
