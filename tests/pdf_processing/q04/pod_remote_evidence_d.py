...
STREAM_FILES = {
    "state/yolo-pod-cgroup-d-measurement/resource-attribution.jsonl",
    "vm-controller.jsonl",
    "workload.log",
}
FINAL_REQUIRED = {
    "state/yolo-pod-cgroup-d/phase-complete.json",
    "state/yolo-pod-cgroup-d/reviewed-window-contract.json",
    "state/yolo-pod-cgroup-d/fresh-index.json",
    "state/yolo-pod-cgroup-d/fresh-07/accepted.json",
    "state/yolo-pod-cgroup-d/fresh-07/document.json",
    "state/yolo-pod-cgroup-d/fresh-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-d/restored-07/accepted.json",
    "state/yolo-pod-cgroup-d/restored-07/document.json",
    "state/yolo-pod-cgroup-d/restored-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-d/replay-07/accepted.json",
    "state/yolo-pod-cgroup-d/replay-07/document.json",
    "state/yolo-pod-cgroup-d/replay-07/source-reviewed-equivalence.json",
    "state/yolo-pod-cgroup-d-measurement/resource-attribution.jsonl",
    "state/yolo-pod-cgroup-d-measurement/resource-attribution-summary.json",
    "state/yolo-pod-cgroup-d-measurement/measurement-contract.json",
    "workload-exit.json",
...
ALLOWED_PREFIXES = (
    "state/yolo-pod-cgroup-d/",
    "state/yolo-pod-cgroup-d-measurement/",
)
