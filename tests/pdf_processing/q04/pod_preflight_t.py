"""T pre-inference gates for the corrected Q04 warm sequence."""
...
_spec = importlib.util.spec_from_file_location(
    "q04_pod_preflight_t_engine", Path(__file__).with_name("pod_preflight_q.py")
)
...
TOPOLOGY_PHASE = "q04-pod-cgroup-t"
RUN_ID = "q04-warm-pod-cgroup-20260921-t"
sha256 = base.base.sha256


def verify_configuration_t(**kwargs):
...
def verify_workload_imports_t(*, workspace, bundle, prefix):
    modules = (
        "candidate.warm_pod_window_r",
        "pod_init_p",
        "pod_workload_t",
        "pod_remote_evidence_t",
    )
    ...
    path = workspace / "tests/pdf_processing/q04/pod-topology-v19/RUNTIME-INTEGRATION-MANIFEST.json"
...
base.RUN_ID = RUN_ID
base.verify_configuration_q = verify_configuration_t
base.verify_workload_imports_q = verify_workload_imports_t
main = base.main
