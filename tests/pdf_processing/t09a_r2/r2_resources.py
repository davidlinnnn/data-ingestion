...
RUN_ID=os.environ.get('T09A_R2_RUN','20260914-0b537d0-a')
...
'''
    ...
    frozen={'run_id':RUN_ID,'producer':hashlib.sha256(json.dumps(code,sort_keys=True).encode()).hexdigest(),
    ...
    k('cp',str(ROOT/'tests/pdf_processing/t09a_r2/verify.py'),f'coordinator:{base}-test/verify.py')
