"""THROWAWAY S3 completion protocol. No local paths enter accepted manifests.

Not yet connected to recovery.py. Requires an isolated bucket/prefix where experiment
writers do not delete or overwrite objects. A passed unit probe is not S3 evidence.
"""
import hashlib
import json
import uuid
